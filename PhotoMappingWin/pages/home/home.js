...
(function () {
    ...
    var homePage = WinJS.UI.Pages.define("/pages/home/home.html", {
        ...
        ready: function (element, options) {
            ...
            var toggleButton = document.getElementById("exchangeMarkerButton");
            if (trailVersion) {
                toggleButton.disabled = true;
                toggleButton.innerText = "Toggle Marker(Trial Version)";
            }
            else {
                toggleButton.disabled = false;
                toggleButton.addEventListener("click", exchangeMarker, false);
            }
            ...
            function exchangeMarker() {
                var pushpin = map.entities.get(currentMarkerIndex);
                if (pushpin instanceof Microsoft.Maps.Pushpin) {
                    var pushpinOptions = null;
                    if (pushpin._icon === "/images/blue_marker.png") {
                        pushpinOptions = { icon: '///Bing.Maps.JavaScript/images/poi_search.png', visible: true };
                        Data.photoArray[currentMarkerIndex].marker = false;
                    }
                    else {
                        pushpinOptions = { icon: '/images/blue_marker.png', visible: true };
                        Data.photoArray[currentMarkerIndex].marker = true;
                    }
            ...
            function initMap() {
               ...
               function DisplayLoc(e) {
                   if (e.targetType == 'pushpin') {
                       ...
                       currentMarkerIndex = e.target.getText();

                       if (defaultInfobox != null) {
                           hideInfobox();
                       }

                       imageFile = Data.photoArray[currentMarkerIndex];
                       getLocation(Data.photoArray[currentMarkerIndex].latitude, Data.photoArray[currentMarkerIndex].longitude, true);

                       if (Data.loc != null) {
                           if (typeof Data.loc.locationStatus === 'undefined') {
                               var d = getDistanceFromLatLonInKm(Data.photoArray[currentMarkerIndex].latitude, Data.photoArray[currentMarkerIndex].longitude,
                       ...
                       WinJS.Binding.processAll(contentGrid, Data.photoArray[currentMarkerIndex]);
                   }
               }
